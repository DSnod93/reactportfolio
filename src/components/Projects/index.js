        ...
        <Container className="text-center" fluid>
            ...
            <Row>
                <Col md={true}>
                    ...
                    <Button className="m-5"><a href="https://github.com/DSnod93/Cuisine-Time" className="text-white text-decoration-none">Click Here</a></Button>
                </Col>
                <Col md={true}>
                    ...
                    <Button className="m-4"><a href="https://github.com/team-8food/food-blog" className="text-white text-decoration-none">Click Here</a></Button>
                </Col>
                <Col md={true}>
                ...
                <Col md={true}>
                    ...
                    <Button className="m-4"><a href="https://github.com/DSnod93/notepad" className="text-white text-decoration-none">Click Here</a></Button>
                </Col>
                <Col md={true}>
                    <Image className="mt-5" src={work2} width="350" height="320" />
                    <h3 className="mt-4">Run-Buddy</h3>
                    <p>HTML, CSS</p>
                    <Button className="m-4"><a href="https://github.com/DSnod93/run-buddy" className="text-white text-decoration-none">Click Here</a></Button>
                </Col>
                <Col md={true}>
                    ...
                    <Button className="m-4"><a href="https://github.com/DSnod93/work-day-scheduler" className="text-white text-decoration-none">Click Here</a></Button>
                </Col>
            </Row>
        </Container>
    )
